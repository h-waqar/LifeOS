...
- **Prevention Strategy:** Explicit relational tables with foreign keys, unique constraints, check constraints, and typed ORM schemas as mandated by PRD Section 43.
