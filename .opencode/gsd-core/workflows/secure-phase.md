...
```
Agent(
  prompt="Read /home/hw/Projects/LifeOS/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/hw/Projects/LifeOS/.opencode/gsd-core/templates/SECURITY.md`
