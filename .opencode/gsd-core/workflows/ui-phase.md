...
```markdown
Read /home/hw/Projects/LifeOS/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/hw/Projects/LifeOS/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/hw/Projects/LifeOS/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/home/hw/Projects/LifeOS/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/hw/Projects/LifeOS/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/hw/Projects/LifeOS/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/hw/Projects/LifeOS/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
