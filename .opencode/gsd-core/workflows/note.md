...
- **Global scope**: `/home/hw/Projects/LifeOS/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/hw/Projects/LifeOS/.opencode/notes/`)
...
2. Glob `/home/hw/Projects/LifeOS/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/hw/Projects/LifeOS/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/hw/Projects/LifeOS/.opencode/notes/` — works in any directory
