...
ones). Reference: @/home/hw/Projects/LifeOS/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/hw/Projects/LifeOS/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/hw/Projects/LifeOS/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/hw/Projects/LifeOS/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/hw/Projects/LifeOS/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/hw/Projects/LifeOS/.opencode/gsd-core/templates/spec.md.
