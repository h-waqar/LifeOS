...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/hw/Projects/LifeOS/.opencode/.gsd-surface.json`
(sibling to `/home/hw/Projects/LifeOS/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/hw/Projects/LifeOS/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/hw/Projects/LifeOS/.opencode/skills`).
...
`/home/hw/Projects/LifeOS/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/hw/Projects/LifeOS/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/hw/Projects/LifeOS/.opencode/.gsd-surface.json`
Install profile marker: `/home/hw/Projects/LifeOS/.opencode/.gsd-profile`
Skill dirs: `/home/hw/Projects/LifeOS/.opencode/skills/gsd-*/`
Engine module: `/home/hw/Projects/LifeOS/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/hw/Projects/LifeOS/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
